...
{  
  ...
  if( wf->PropertyExists( wf_entity, "colors" ) )
    ...
    AddVisualizer( &this->vis, wf->ReadInt(wf_entity, "image_show", 0) == 1 );    
}
...
//Option ModelBlobfinder::showBlobData( "Show Blobfinder", "show_blob", "", false, NULL );

ModelBlobfinder::Vis::Vis( World* world ) 
  : Visualizer( "Blobfinder", "blobfinder_vis" )
{
  
  //world->RegisterOption (&showBlobData);
