 ...
 *
 * $Id: PlayerActarrayData.java 125M 2011-03-24 02:24:05Z (local) $
 *
 */
...
public class PlayerActarrayData implements PlayerConstants {
    ...
    public byte getMotor_state() {
        return motor_state;
    }

    public void setMotor_state(byte motor_state) {
